...
<!-- ***********   START   *********** -->
<div class="mainWrapper col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2">
	<div class="centerformWrapper col-lg-4 col-md-6 col-sm-12 col-xs-4">
		...
		<form name="loginForm" action="LoginFormController" onsubmit="return validateLogin4();" method="post" >
				...
				<div class="form-group">
					&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="submit" class="btn btn-success" value="Submit"/>&emsp;&emsp;&emsp;
