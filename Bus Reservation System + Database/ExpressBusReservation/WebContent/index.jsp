...
<div class="mymainWrapper col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="leftWrapper col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2">
            <form name="SearchBusFormController" action="SearchBusFormController"
                ...
                <div class="form-group col-lg-8 col-md-7 col-sm-10 col-xs-10">
                    <button type="submit"
                            class="btn btn-success col-lg-5 col-md-5 col-sm-5 col-xs-5"
    ...
    <div class="rightWrapper col-lg-5 col-md-5 col-sm-12 col-xs-12">
        ...
        <div class="centertitle forgotpwd col-lg-8 col-md-7 col-sm-10 col-xs-10 col-lg-offset-2">
            <a href="ForgotPassword1.jsp">Forgot Password? Click Here</a>
        </div>
        <div class="centertitle logOptions col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <a href="BusOperatorLogin.jsp">Login as Bus Operator </a> | <a href="RegisterUser.jsp"> Sign Up</a> | <a href="AdminLogin.jsp">Admin Login</a>
        </div>
