	...
	<div class="dashboardBody col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="dashboarddiv col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="odd col-lg-3 col-md-4 col-sm-12 col-xs-12">
				...
				<div class="odd col-lg-3 col-md-4 col-sm-12 col-xs-12">
				<div class="dashimg">
					<span class="glyphicon glyphicon-search"></span>Connect to people
				</div>
				
				<div class="dashcontent">
					<a href="connectToPeople.jsp">Connect</a>
				</div>
			</div>
			...
			<div class="odd  col-lg-3 col-md-3 col-sm-12 col-xs-12">		
				<div class="dashimg">
					<span class="glyphicon glyphicon-eye-open"></span>View Feedback
				</div>
				<div class="dashcontent">
					<a href="viewfeedback.jsp">View</a>	
				</div>
			</div>
			...
			<div class="even col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<div class="dashimg">
					<span class="glyphicon glyphicon-list-alt"></span>Feedback
					</div>
				<div class="dashcontent">					
					<a href="feedbackByuser.jsp">write</a>
				</div>
			</div>
